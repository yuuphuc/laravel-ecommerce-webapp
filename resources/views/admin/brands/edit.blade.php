...
<x-alert></x-alert>
@include('admin.brands.bra-update')
@endsection
...
<script>
    $(document).ready(function() {
        $('#bra-update').on('submit', function(e) {
            ...
            let form = $(this);
            let url = "{{ route('bra.update', $brand->id) }}"; // endpoint
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.errorflag === 'success' && res.updated) {
                        ...
                        $(`input[name="status"][value="${res.updated.status}"]`).prop('checked', true);
                    }
