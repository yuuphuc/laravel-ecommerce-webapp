<div class="row">
    <div class="card-header">
        ...
        <td>
            <a href="{{route('pro.create')}}" class="btn btn-sm btn-success me-1" title="Thêm">Thêm sản phẩm <i class="fas fa-plus"></i></a>
        </td>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button"
                            ...
                            data-action="{{ route('pro.delete', ['id' => $item->id]) }}">
                            <i class="fas fa-trash" title="Xóa"></i>
                        </button>

                        <a href="{{ route('pro.edit', $item->id) }}" class="btn btn-sm btn-warning text-white me-1" title="Sửa"><i class="fas fa-edit"></i></a>
